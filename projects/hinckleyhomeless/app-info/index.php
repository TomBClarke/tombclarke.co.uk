    ...
    <body>
        <div class="main">
            ...
            <div class="section">
                ...
                <p>Lawrence House welcomes all applications. The Accommodation is suitable for:</p>
                <ul>
                    <li>Single people aged 16-24 years old, without dependants</li>
                    <li>People actively seeking to improve their situation</li>
                    <li>Those who want to succeed with the support we can offer</li>
                    <li>Those who really do want to take the first steps in achieving their own sustainable accommodation</li>
                </ul>
                <p>All candidates are individually risk assessed for suitability to become a resident at Lawrence House and this will include history of criminal convictions.  The project may not be able to accommodate people with a severe mental health problem, or acute dependency on drugs or alcohol.  If a prospective resident has been convicted of, or suspected of, arson, sexual offences or serious violence, then again, we may not be able to offer accommodation.  Lawrence House is a higher support level, short term accommodation project.  Referrals are only refused if health and safety risks are unacceptable or the eligibility criteria are not met.
</p>
                <p>Each referral will be considered carefully, taking into account the needs of the already existing resident group as well as the needs of the prospective resident and the level of support that can be offered both from within and outside the project.
</p>
                <p>A support agreement may need to be signed by a social worker or other professional, before a client is accepted. This may happen when the support needs of the client are higher than can be provided by the staff team at Lawrence House.
</p>
                <p>There is a detailed procedure that sets out how staff will deal with interviews to make sure we treat all potential residents fairly, and to make sure we properly record how we have treated individuals in case anyone complains.
</p>
